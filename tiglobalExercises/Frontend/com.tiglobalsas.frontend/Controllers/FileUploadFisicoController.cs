...
namespace com.tiglobalsas.frontend.Controllers
{
    public class FileUploadFisicoController : Controller
    {
        private readonly AppDbContext _context;
        private readonly long _fileSizeLimit;
        private readonly ILogger<FileUploadFisicoController> _logger;
        ...
        public FileUploadFisicoController(ILogger<FileUploadFisicoController> logger, 
        ...
        public async Task<IActionResult> UploadDatabase()
        {
                        ...
                        .HasFileContentDisposition(contentDisposition))
                    {
                        ...
                        streamedFileContent = 
                            await FileHelpers.ProcessStreamedFile(section, contentDisposition, 
                                ModelState, _permittedExtensions, _fileSizeLimit, _targetFilePath);
            ...
            return Created(nameof(FileUploadFisicoController), null);
        }
        #endregion
                ...
                if (hasContentDispositionHeader)
                {
                    ...
                    else
                    {
                        ...
                        var streamedFileContent = await FileHelpers.ProcessStreamedFile(
                            ...
                            _permittedExtensions, _fileSizeLimit, _targetFilePath);
